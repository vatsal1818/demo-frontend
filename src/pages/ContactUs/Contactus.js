...
import { SEND_EMAILS, ADMIN_CONTACT_US } from '../../helper/Apihelpers';
        ...
        <div className="contact-page">
            ...
            <div className="contact-header">
                <h1 className="contact-title">
                    {pageContent.title}
                    <span className="highlight">{pageContent.titleSpan}</span>
                </h1>
                <p className="contact-description">{pageContent.paragraph}</p>
                {pageContent.email && (
                    <div className="contact-email">
                        Email us at: <a href={`mailto:${pageContent.email}`}>{pageContent.email}</a>
                    </div>
                )}
            </div>
